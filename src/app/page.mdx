...
VostokFramework was a great case study for myself because I've studied and applied several software engineering topics on it, including [Object-Oriented Design Principles](http://c2.com/cgi/wiki?PrinciplesOfObjectOrientedDesign), [Design Patterns](http://en.wikipedia.org/wiki/Software_design_pattern), [Framework Design Guidelines](http://www.amazon.com/Framework-Design-Guidelines-Conventions-Libraries/dp/0321545613), [Unit Testing](http://en.wikipedia.org/wiki/Unit_testing), [Test-Driven Development](http://en.wikipedia.org/wiki/Test-driven_development), [Layered Architecture](https://www.oreilly.com/library/view/software-architecture-patterns/9781491971437/ch01.html), [Domain-Driven Design](http://en.wikipedia.org/wiki/Domain-driven_design), among others. So, the result is a beautiful, carefully crafted OO design, totally based on best practices and patterns. Therefore, although it's not production ready, it's a great piece of study for anyone willing to improve their skills in those topics.
